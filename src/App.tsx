...
function App() {
  ...
  htmlInlineStylesConvertor.GetReactStyleByInlineInput("");
  ...
  <div className="row">
    ...
    >
      ...
      <canvas className="my-4 w-100 chartjs-render-monitor" id="myChart" width="2073" height="875"       
      style=
      {htmlInlineStylesConvertor.GetReactStyleByInlineInput("display: block; width: 2073px; height: 875px;")} 
